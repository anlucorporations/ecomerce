...
export const metadata = {
  title: "BARLO-VENTAS | Pasarela de Pago Web3 en EuroToken (EURT)",
  description: "Pasarela de pago descentralizada e inmutable con EuroToken EURT para BARLO-VENTAS Web3",
};
              ...
              <a href="http://localhost:3001" className="flex items-center gap-2.5 group shrink-0">
                ...
                <div className="hidden sm:block">
                  <span className="text-xl font-black tracking-tight text-[#333333] group-hover:text-[#0077BB] transition-colors font-poppins">
                    BARLO-<span className="text-[#FF8800]">VENTAS</span> <span className="text-[10px] px-2 py-0.5 rounded-full bg-[#E6F4FA] text-[#0077BB] border border-[#0077BB]/30 font-mono font-bold">Pasarela Web3</span>
                  </span>
                  <span className="text-[10px] text-[#0077BB] block font-semibold">El Ritmo de tus Compras &bull; Liquidación Custodia Escrow</span>
                </div>
              </a>
        ...
        <footer className="bg-white/80 backdrop-blur-md border-t border-[#0077BB]/10 py-8 mt-12">
          <div className="max-w-7xl mx-auto px-4 text-center text-xs text-[#333333] space-y-2">
            <p className="font-bold text-[#0077BB] font-poppins text-sm">
              BARLO-VENTAS Web3 &copy; 2025 - Pasarela de Pago Inmutable & Custodia Escrow
            </p>
            <p className="text-[11px] text-[#A9A9A9] font-mono">
              EuroToken (EURT) &bull; Red Ethereum Local &bull; Auditoría Smart Contract Inmutable
            </p>
          </div>
        </footer>
      </body>
