        ...
        <div className="flex items-center justify-between p-5 border-b border-slate-800 bg-gradient-to-r from-slate-900 via-indigo-950/40 to-slate-900">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Guía rápida para visualizar tus saldos de EURT en MetaMask</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6 max-h-[75vh] overflow-y-auto">
          ...
          <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl space-y-3">
            <div className="flex justify-between items-center text-xs text-slate-400 border-b border-slate-800 pb-2">
              <span className="font-semibold text-slate-300">Ficha Técnica del Token</span>
              <span className="font-mono bg-indigo-950 text-indigo-300 px-2 py-0.5 rounded border border-indigo-800/40">
                ERC-20 Standard
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
              <div>
                <span className="block text-slate-500 text-[10px]">SÍMBOLO:</span>
                <span className="font-bold text-amber-400">EURT</span>
              </div>
              <div>
                <span className="block text-slate-500 text-[10px]">DECIMALES:</span>
                <span className="font-bold text-emerald-400">6</span>
              </div>
              <div>
                <span className="block text-slate-500 text-[10px]">RED DE PRUEBAS:</span>
                <span className="font-mono text-slate-300">Anvil Local (31337)</span>
              </div>
            </div>
            ...
            <div className="pt-1">
              ...
              <div className="flex items-center gap-2 bg-slate-900 border border-slate-700/60 rounded-lg p-2 font-mono text-xs text-indigo-300 break-all">
                <span className="flex-1 select-all">{euroTokenAddress}</span>
                <button
                  onClick={handleCopy}
                  className="px-3 py-1 bg-indigo-600 hover:bg-indigo-500 text-white rounded text-[11px] font-sans font-bold transition flex items-center gap-1 shrink-0"
                >
            ...
            <div className="space-y-4">
              <div className="p-4 bg-indigo-950/30 border border-indigo-500/20 rounded-xl space-y-2">
                ...
                <p className="text-xs text-slate-300 leading-relaxed">
                  Si tiene la extensión de MetaMask instalada y desbloqueada, haga clic en el siguiente botón. MetaMask le solicitará automáticamente confirmar la adición del token <strong>EURT</strong> a su lista de activos sin necesidad de escribir datos manualmente.
                </p>
              </div>
              ...
              <div className="text-center py-2">
                <button
                  ...
                  className="px-6 py-3.5 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-400 hover:to-orange-500 text-slate-950 font-bold rounded-xl shadow-lg shadow-amber-500/10 transition transform active:scale-95 disabled:opacity-50 flex items-center justify-center gap-3 mx-auto text-sm"
                >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 text-xs">
                ...
                <div className="flex items-start gap-3 p-3 bg-slate-950 border border-slate-800 rounded-xl">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-200">Abre tu billetera MetaMask</h4>
                    <p className="text-slate-400 text-[11px] mt-0.5">
                      Haz clic en el icono del zorro 🦊 en la barra de extensiones de tu navegador y verifica que estés conectado a la red local (<strong>Anvil Localhost 8545</strong>).
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-slate-950 border border-slate-800 rounded-xl">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-200">Ve a la pestaña de Activos (Tokens)</h4>
                    <p className="text-slate-400 text-[11px] mt-0.5">
                ...
                <div className="flex items-start gap-3 p-3 bg-slate-950 border border-slate-800 rounded-xl">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-200">Haz clic en &quot;+ Importar Tokens&quot;</h4>
                    <p className="text-slate-400 text-[11px] mt-0.5">
                ...
                <div className="flex items-start gap-3 p-3 bg-slate-950 border border-slate-800 rounded-xl">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-200">Pega los datos del contrato</h4>
                    <p className="text-slate-400 text-[11px] mt-0.5">
                      Selecciona la pestaña <strong>Token Personalizado</strong> y completa los siguientes campos:
                    </p>
                    <ul className="mt-1.5 space-y-1 text-slate-300 font-mono text-[11px] pl-2 border-l-2 border-indigo-500">
                ...
                <div className="flex items-start gap-3 p-3 bg-slate-950 border border-slate-800 rounded-xl">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-200">Confirma la importación</h4>
                    <p className="text-slate-400 text-[11px] mt-0.5">
