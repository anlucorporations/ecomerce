export const CONTRACT_ADDRESSES = {
  81234: {
    ecommerce: process.env.NEXT_PUBLIC_ECOMMERCE_MAIN_ADDRESS || process.env.NEXT_PUBLIC_ECOMMERCE_CONTRACT_ADDRESS || '0x5FC8d32690cc91D4c39d9d3abcBD16989F875707',
