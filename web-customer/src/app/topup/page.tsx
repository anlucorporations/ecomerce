...
export default function TopupPage() {
  ...
  const fetchBalance = async () => {
    ...
    try {
      ...
      try {
        const ecom = new ethers.Contract(ecommerceAddress, ['function euroTokenAddress() view returns (address)'], rpcProvider);
        const onChainToken = await ecom.euroTokenAddress();
