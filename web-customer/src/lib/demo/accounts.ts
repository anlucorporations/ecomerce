...
// Cuentas públicas estándar de prueba del motor Anvil/Foundry
// NOTA: Estas claves son exclusivamente para entornos locales y demos con fondos de prueba sin valor comercial.
...
export function isDemoModeEnabled(): boolean {
  // Por defecto activo en desarrollo o si la variable de entorno está presente
  if (typeof process !== 'undefined' && process.env.NEXT_PUBLIC_DEMO_MODE !== undefined) {
    return process.env.NEXT_PUBLIC_DEMO_MODE === 'true';
  }
  return true; // En modo local/demo siempre disponible
}
